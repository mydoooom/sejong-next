...
export default function TrainingSessions({gMapsApiKey}: Props) {
    ...
    const locations = [
        ...
        },
        {
            ...
            tram: [`Sídliště Libuš (17), Libuš (17)`],
            bus: ['Sídliště Libuš (197, 215)', 'Libuš (197, 215)'],
            lat: 50.0085,
            lng: 14.4514
        }
    ]
                ...
                <Container>
                    <Grid container spacing={2}>
                        {locations.map(location => (
                            <Grid item xs={12} sm={12} md={6} lg={6} xl={6} key={location.name}
